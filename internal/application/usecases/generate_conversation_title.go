...
// autoGeneratedTitlePattern matches titles like "Conversation 2024-01-15 14:30" or "New Chat"
var autoGeneratedTitlePattern = regexp.MustCompile(`^(Conversation \d{4}-\d{2}-\d{2} \d{2}:\d{2}|New Chat)$`)
