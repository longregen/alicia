...
type SyncResponse struct {
	...
	SyncedAt       string          `json:"synced_at" msgpack:"syncedAt"`             // Server timestamp of sync (ISO 8601)
}
...
type SyncStatusResponse struct {
	...
	LastSyncedAt   string `json:"last_synced_at,omitempty" msgpack:"lastSyncedAt,omitempty"` // Last sync timestamp (ISO 8601)
}
