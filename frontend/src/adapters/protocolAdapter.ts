...
export function handleReasoningStep(
  ...
  // Wrap reasoning content in <reasoning> tags with sequence and id for ChatBubble to parse
...
/**
 * Set the message sender function (called by useLiveKit or connection manager)
 * Pass null to clear the sender when disconnecting
 */
...
export function sendFeedback(feedback: Feedback): void {
  ...
  const envelope: Envelope = {
    stanzaId: Date.now(), // Simple stanza ID generation
